...
# ============================ step 1/5 数据 ============================
cwd = os.getcwd()
split_dir = os.path.join(cwd, 'RMB_data', "split")
...
test_loader = DataLoader(dataset=valid_data, batch_size=BATCH_SIZE)
...
for i, data in enumerate(test_loader):
    ...
    print(f"模型预测为{rmb}元，实际为{rmb_label_}元")

my_dir = os.path.join(cwd, 'transform_img_RMB', "src")
